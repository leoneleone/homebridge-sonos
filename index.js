...
function SonosAccessory(log, config) {
  ...
  this.service
    .addCharacteristic(Characteristic.Brightness)//Changed VolumeCharacteristic to Characteristic.Brightness, so Volume can also be controlled using Siri Commands.
    .on('get', this.getVolume.bind(this))
    .on('set', this.setVolume.bind(this));
